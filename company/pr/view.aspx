<%@ Page Language="C#" AutoEventWireup="true" CodeFile="view.aspx.cs" Inherits="company_pr_view" MasterPageFile="~/main.Master"%>
...
<asp:Content ID="head_script" runat="server" ContentPlaceHolderID="head_script">	    
    <script type="text/javascript" src="/ko/company/pr/view.js"></script>    
...
<asp:Content runat="server" ID="body" ContentPlaceHolderID="body">
    ...
    <div id="contents" class="subContents" ng-app="ls" ng-cloak ng-controller="defaultCtrl">
        <div id="company">
            ...
            <!----- 서브 컨텐츠 (s) ----->
            <div class="subpage_wrapper promotion">
                ...
                <div class="container animElement">
                    <div class="detail_box">
                        <div class="wrap_board_view1">
                            <!-- 제목 -->
                            <div class="view_top_type1">
                                <p class="view_tit">{{entity.b_title | limitHtml}}</p>
                                <p class="date">{{entity.b_regdate | date:'yyyy.MM.dd'}}</p>
                            </div>
                            <!-- //제목 -->
                        ...
                        <div class="btn_bottom">
                            <a href="#"  ng-click="pathToGo('list', $event)" class="btn_typeA1"><span><asp:Literal runat="server" meta:resourcekey="btn_list"/></span></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="container animElement">
                    <div class="detail_box">
                        <div class="wrap_board_view1">
                            ...
                            <div class="view_navi">
                                <div class="page" ng-if="prevnext.prev_b_id!=null">
                                    <a href="#" ng-click="pathToGo('prev', $event)" class="doc_txt prev"><span><asp:Literal runat="server" meta:resourcekey="prev_txt"/></span></a>                                                                        
                                </div>
                                <div class="page" ng-if="prevnext.next_b_id!=null">
                                    <a href="#"  ng-click="pathToGo('next', $event)" class="doc_txt next"><span><asp:Literal runat="server" meta:resourcekey="next_txt"/></span></a>                                                                        
                                </div>
                            </div>                            
                            <!--// 이전/다음글 -->
                        </div>
